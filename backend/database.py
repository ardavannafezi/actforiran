...
def seed_defaults(db):
    ...
    super_admin_email = os.getenv("SUPER_ADMIN_EMAIL") or os.getenv("INITIAL_ADMIN_EMAIL", "**")
    super_admin_password = os.getenv("SUPER_ADMIN_PASSWORD") or os.getenv("INITIAL_ADMIN_PASSWORD", "**")
