...
def _build_prompt(
    ...
    system_prompt = (
        ...
        "- If multiple recipients, address them collectively\n"
        "- Vary your greetings, tone, and structure to make each email unique\n"
        "- Use only the provided information - do not invent facts\n"
        "- Do NOT include the word 'Subject:' in the subject line\n"
        "- If no sender name is provided, write the email without mentioning any name\n"
        "- End with a simple closing followed by sender name ONLY if name was provided\n\n"
        "OUTPUT FORMAT:\n"
        "Line 1: Subject line (no 'Subject:' prefix)\n"
        "Line 2: Blank\n"
        "Line 3: Greeting\n"
        "Line 4: Blank\n"
        "Body: Natural flowing paragraphs\n"
    ...
    user_prompt = (
        ...
        "- If multiple recipients, use plural addressing\n"
